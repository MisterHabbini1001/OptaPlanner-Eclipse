...
public class EmployeeTest 
{
	...
	*/
	...
	@Test
    public void testgetUnavailableDaySet() 
    {
		System.out.println(unavailableDaySet);
    }

	@Test
    public void testsetUnavailableDaySet() 
    {
        this.unavailableDaySet = unavailableDaySet;
    }

	@Test
    public void testgetFlightAssignmentSet() 
    {
		System.out.println(flightAssignmentSet);
    }

	@Test
    public void testsetFlightAssignmentSet() 
    {
