...
public class ThermoKingPlanningPanel extends SolutionPanel<TaskAssigningSolution> {

    public static final String LOGO_PATH = "/org/optaplanner/examples/thermokingplanning/swingui/thermoking_2.png";

    private final ThermoKingPlanningOverviewPanel taskOverviewPanel;
    ...
    private ThermoKingPlanningWorldPanel taskWorldPanel;//changed Habbo
    
    public ThermoKingPlanningPanel() {
    	//habbo+
    	/*
    	original+
    	...
    	*/
        ...
        taskOverviewPanel = new ThermoKingPlanningOverviewPanel(this);
        JScrollPane scrollPane = new JScrollPane(taskOverviewPanel);
        tabbedPane.add("Gantt", scrollPane);
        taskWorldPanel = new ThermoKingPlanningWorldPanel(this);
