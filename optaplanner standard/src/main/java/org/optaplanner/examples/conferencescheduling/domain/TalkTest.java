...
public class TalkTest 
{
   ...
   public void testhasAnyUnavailableSpeaker() 
    ...
    @Test
    public void testwithContentTagSet() 
    {
        this.contentTagSet = contentTagSet;
        System.out.println(this);
    }
    ...
    @Test
    public void testwithMutuallyExclusiveTalksTagSet() 
    {
        this.mutuallyExclusiveTalksTagSet = mutuallyExclusiveTalksTagSet;
        System.out.println(this);
    }
    ...
    @Test
    public void testwithPrerequisiteTalksCodesSet() 
    {
        System.out.println(this);
    }

    @Test
    public void testwithTimeslot() 
    {
        System.out.println(this);
    }
