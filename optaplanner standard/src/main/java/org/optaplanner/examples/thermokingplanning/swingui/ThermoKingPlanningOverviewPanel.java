...
public class ThermoKingPlanningOverviewPanel extends JPanel implements Scrollable {
    ...
    public ThermoKingPlanningOverviewPanel(ThermoKingPlanningPanel taskAssigningPanel) {
    ...
    private class TaskAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int result = JOptionPane.showConfirmDialog(ThermoKingPlanningOverviewPanel.this.getRootPane(),
