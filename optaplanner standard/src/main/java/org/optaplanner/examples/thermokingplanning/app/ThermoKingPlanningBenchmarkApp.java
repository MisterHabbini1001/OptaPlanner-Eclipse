...
public class ThermoKingPlanningBenchmarkApp extends CommonBenchmarkApp {

    public static void main(String[] args) {
        new ThermoKingPlanningBenchmarkApp().buildAndBenchmark(args);
    }

    public ThermoKingPlanningBenchmarkApp() {
        super(
